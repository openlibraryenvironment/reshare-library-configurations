  ...
  <xsl:template match="//marc:record">
    ...
    <holdingsRecords>
      ...
      <xsl:if test="marc:datafield[@tag='945']">
        <xsl:for-each select="marc:datafield[@tag='945' and ./marc:subfield[@code='l']]">
          ...
          <xsl:variable name="itype" select="../marc:datafield[@tag='998']/marc:subfield[@code='b']"/>
          <xsl:if test="not($loc=$preloc)">
            <i>
              ...
              <callNumberTypeId>
                <xsl:choose>
                  <xsl:when test="../marc:datafield[@tag='099' or @tag='090']">6caca63e-5651-4db6-9247-3205156e9699</xsl:when> <!-- other -->
              ...
              <items>
                ...
                <xsl:for-each select="../marc:datafield[@tag='945']/marc:subfield[@code='l'][.=$loc]/..">
                  <i>
                    <xsl:variable name="volume" select="./marc:subfield[@code='u']" />
                    <itemIdentifier>
