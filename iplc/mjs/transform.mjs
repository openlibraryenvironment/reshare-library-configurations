...
const localFields = {
  ...
  'US-CTY': {
    ...
    lendLocs: [ 'artdesk', 'artdisplay', 'artmain', 'artnew', 'artpopup', 'arttransfe', 'bassgraph', 'bassmain', 'divcd', 'divdmr', 'divmain', 'lawbl', 'lsfart', 'lsfdiv', 'lsfgdc', 'lsfi', 'lsfmain', 'lsfmarx', 'lsfmarxmap', 'lsfmtn', 'lsfmus', 'marxmain', 'medbiog', 'medhs', 'medhum', 'medmain', 'medrefeol', 'musmain', 'musmic', 'musrec', 'new', 'rr', 'smlfolio', 'smllnb', 'smllnbm', 'smllts', 'smlmic', 'smlmicr', 'smlstacks', 'smltadoku' ]
