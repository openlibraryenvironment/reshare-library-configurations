          ...
          <arr>
            <xsl:for-each select="marc:datafield[@tag='900' and @ind1!='4' and @ind1!=' ']">
              ...
              <i>
                ...
                <illPolicyId>
                  <xsl:choose>
                    <xsl:when test="$LOC='WWH d-child'"><xsl:value-of select="$WILL_LEND"/></xsl:when>
                    <xsl:when test="$LOC='HHN d-dvd'"><xsl:value-of select="$WILL_LEND"/></xsl:when>
                    <xsl:when test="$LOC='QL d-dvd'"><xsl:value-of select="$WILL_LEND"/></xsl:when>
                    <xsl:when test="$LOC='WWH d-dvd'"><xsl:value-of select="$WILL_LEND"/></xsl:when>
                    <xsl:when test="$LOC='HHN d-leisure'"><xsl:value-of select="$WILL_LEND"/></xsl:when>
                    <xsl:when test="$LOC='WWH d-leisure'"><xsl:value-of select="$WILL_LEND"/></xsl:when>
                    <xsl:when test="$LOC='HHN d-oversize'"><xsl:value-of select="$WILL_LEND"/></xsl:when>
                    <xsl:when test="$LOC='WWH d-oversize'"><xsl:value-of select="$WILL_LEND"/></xsl:when>
                    <xsl:when test="$LOC='HHN d-stacks'"><xsl:value-of select="$WILL_LEND"/></xsl:when>
                    <xsl:when test="$LOC='QL d-stacks'"><xsl:value-of select="$WILL_LEND"/></xsl:when>
                    <xsl:when test="$LOC='WWH d-stacks'"><xsl:value-of select="$WILL_LEND"/></xsl:when>
                    <xsl:when test="$LOC='WWH d-stacks-1'"><xsl:value-of select="$WILL_LEND"/></xsl:when>
                    <xsl:when test="$LOC='WWH d-td-1'"><xsl:value-of select="$WILL_LEND"/></xsl:when>
                    <xsl:when test="$LOC='WWH d-teen'"><xsl:value-of select="$WILL_LEND"/></xsl:when>
