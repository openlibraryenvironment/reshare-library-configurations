        ...
        <xsl:for-each select="marc:datafield[@tag='945']">
          ...
          <xsl:if test="not($loc=$preloc)">
            <i>
              ...
              <illPolicyId>
                <xsl:choose>
                  <xsl:when test="$loc-clean='sdsb1'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when> <!-- Will lend -->
                  <xsl:when test="$loc-clean='sdsb2'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when> <!-- Will lend -->
                  <xsl:when test="$loc-clean='sdsb3'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when> <!-- Will lend -->
                  <xsl:when test="$loc-clean='sclsb'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when> <!-- Will lend -->
                  <xsl:when test="$loc-clean='sdccl'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when> <!-- Will lend -->
              ...
              <callNumber>
                <xsl:choose>
                  ...
                  <xsl:when test="../marc:datafield[@tag='099']/marc:subfield[@code='b']">
                    <xsl:value-of select="concat(../marc:datafield[@tag='099']/marc:subfield[@code='a'], ' ', ../marc:datafield[@tag='099']/marc:subfield[@code='b'])"/>
                  </xsl:when>
                  <xsl:when test="../marc:datafield[@tag='099']/marc:subfield[@code='a']">
              ...
              <callNumberTypeId>
                <xsl:choose>
                  <xsl:when test="./marc:subfield[@code='a']">6caca63e-5651-4db6-9247-3205156e9699</xsl:when> <!-- other -->
                  <xsl:when test="../marc:datafield[@tag='090' or @tag='099']/marc:subfield[@code='a']">6caca63e-5651-4db6-9247-3205156e9699</xsl:when> <!-- other -->
              ...
              <items>
                ...
                <xsl:for-each select="../marc:datafield[@tag='945']/marc:subfield[@code='l'][.=$loc]/..">
                  <i>
                    ...
                    <enumeration><xsl:value-of select="./marc:subfield[@code='c']"/></enumeration>
