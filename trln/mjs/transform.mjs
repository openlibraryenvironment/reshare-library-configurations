...
const localFields = {
  ...
  'US-NCU': {
    ...
    lendLocs: ['aa', 'aada', 'aadd', 'aaof', 'bb', 'bbdb', 'bbdc', 'bbla', 'dcpf', 'dcpfb', 'dcps', 'dcpw', 'dcpwc', 'ddda', 'dddb', 'dddc', 'ddof', 'dg', 'dgdaa', 'dgdab', 'dgdac', 'dgdad', 'dgdad', 'dgdae', 'dgdaf', 'dgdda', 'dm', 'dmda', 'dmdb', 'dmdc', 'dq', 'dqda', 'll', 'llda', 'lldac', 'lldb', 'lldc', 'lljd', 'mmda', 'mmdb', 'mmka', 'ssda', 'ssdb', 'ssdc', 'trln', 'troup', 'ua', 'uada', 'ud', 'udba', 'udbb', 'ulbr', 'uldaa', 'uldag', 'uldb', 'uldd', 'uadaf', 'vada', 'wb', 'wbda', 'ydda', 'yddc', 'ydfa', 'ydra' ]
  },
  'US-NCDURC' : {
