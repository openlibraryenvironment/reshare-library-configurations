    ...
    <record>
      <xsl:choose>
        <xsl:when test="substring(marc:leader,6,1)!='d'">
          ...
          <institutionIdHere/>
          <xsl:variable name="identifier" select="marc:datafield[@tag='039' and @ind1 = ' ' and @ind2 = ' ']/marc:subfield[@code='a']"/>
          <localIdentifier>
          ...
          <instance>
            ...
            <identifiers>
              <arr>
                ...
                <xsl:for-each select="marc:datafield[@tag='010' or @tag='020' or @tag='022' or @tag='024' or @tag='028' or @tag='035' or @tag='074'] | marc:controlfield[@tag='001']">
                  <i>
                    <xsl:choose>
                      ...
                      <xsl:when test="current()[@tag='020'] and marc:subfield[@code='a']">
                        ...
                        <identifierTypeId>8261054f-be78-422d-bd51-4ed9f33c3422</identifierTypeId>
                        <!-- ISBN -->
                      </xsl:when>
                      <xsl:when test="current()[@tag='022'] and marc:subfield[@code='a']">
                        ...
                        <identifierTypeId>913300b2-03ed-469a-8179-c1092c991227</identifierTypeId>
                        <!-- ISSN -->
                      </xsl:when>
                      <xsl:when test="current()[@tag='028'] and marc:subfield[@code='a']">
                        ...
                        <identifierTypeId>b5d8cdc4-9441-487c-90cf-0c7ec97728eb</identifierTypeId>
                        <!-- Publisher number -->
                      </xsl:when>
                      ...
                      <xsl:when test="current()[@tag='074'] and marc:subfield[@code='a']">
                        ...
                        <identifierTypeId>351ebc1c-3aae-4825-8765-c6d50dbf011f</identifierTypeId>
                        <!-- GPO item number -->
                      </xsl:when>
                      <xsl:when test="current()[@tag='001'][starts-with(., 'oc')]">
                        <value>
                          <xsl:value-of select="."/>
                        </value>
                      ...
                      <xsl:otherwise>
                        ...
                        <identifierTypeId>2e8b3b6c-0e7d-4e48-bca2-b0b23b376af5</identifierTypeId>
                ...
                <arr>
                  <xsl:for-each select="marc:datafield[@tag='500' or @tag='504' or @tag='505' or @tag='520']">
                    <i>
                      ...
                      <instanceNoteTypeId>
                        <xsl:choose>
                          <xsl:when test="./@tag=&quot;504&quot;">86b6e817-e1bc-42fb-bab0-70e7547de6c1</xsl:when>
                          <!-- biliography -->
                          <xsl:when test="./@tag=&quot;505&quot;">5ba8e385-0e27-462e-a571-ffa1fa34ea54</xsl:when>
                          <!-- contents -->
                          <xsl:when test="./@tag=&quot;520&quot;">0e2e11b-450f-45c8-b09b-0f819999966e</xsl:when>
                          <!-- contents -->
        ...
        <xsl:otherwise>
          <delete>
            <institutionIdHere/>
            <localIdentifier>
              <xsl:value-of select="marc:datafield[@tag='907']/marc:subfield[@code='a']"/>
            </localIdentifier>
            <identifierTypeIdHere/>
          </delete>
        </xsl:otherwise>
