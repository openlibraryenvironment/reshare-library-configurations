        ...
        <xsl:for-each select="marc:datafield[@tag='945']">
          ...
          <xsl:if test="not($loc=$preloc)">
            <i>
              ...
              <illPolicyId>
                <xsl:choose>
                  <xsl:when test="$loc-clean='birnc'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc-clean='birnf'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc-clean='bmain'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc-clean='mcirc'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc-clean='mcres'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc-clean='mllm'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc-clean='mort'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc-clean='mainm'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc-clean='lawl'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
