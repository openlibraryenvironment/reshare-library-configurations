...
-d '{
 ...
 "name" : "Temple - Temple - Ambler Campus Library",
 "code" : "AMBLER",
 "campusId" : "e4cb3320-adba-4412-98fe-1f8576ec50db",
}' \
$protocol://$host/location-units/libraries
...
-d '{
 ...
 "name" : "Temple - Temple - Ambler Archives Collection",
...
-d '{
 ...
 "name" : "Temple - Temple - Ambler Leisure Reading",
...
-d '{
 ...
 "name" : "Temple - Blockson Collection",
 "code" : "BLOCKSON",
 "campusId" : "e4cb3320-adba-4412-98fe-1f8576ec50db"
}' \
$protocol://$host/location-units/libraries
...
-d '{
 ...
 "name" : "Temple - CLA Ed Tech Library",
 "code" : "CLAEDTECH",
 "campusId" : "e4cb3320-adba-4412-98fe-1f8576ec50db"
}' \
$protocol://$host/location-units/libraries
...
-d '{
 ...
 "code" : "US-PPT/US-PPT/CLAEDTECH/media",
 "isActive": true, "institutionId" : "05770b43-8f13-41e3-9ffd-8c13ae570d18",
 "campusId" : "e4cb3320-adba-4412-98fe-1f8576ec50db",
...
-d '{
 ...
 "name" : "Temple - Duckworth Scholars Studio",
 "code" : "DSC",
 "campusId" : "e4cb3320-adba-4412-98fe-1f8576ec50db"
}' \
$protocol://$host/location-units/libraries
...
-d '{
 ...
 "name" : "Temple - Ginsburg Health Science Library",
 "code" : "GINSBURG",
 "campusId" : "e4cb3320-adba-4412-98fe-1f8576ec50db"
}' \
$protocol://$host/location-units/libraries
...
-d '{
 ...
 "name" : "Temple - Harrisburg Campus Library",
 "code" : "HARRISBURG",
 "campusId" : "e4cb3320-adba-4412-98fe-1f8576ec50db"
}' \
$protocol://$host/location-units/libraries
...
-d '{
 ...
 "name" : "Temple - Japan Campus Library",
 "code" : "JAPAN",
 "campusId" : "e4cb3320-adba-4412-98fe-1f8576ec50db"
}' \
$protocol://$host/location-units/libraries
...
-d '{
 ...
 "name" : "Temple - Rome Campus Library",
 "code" : "ROME",
 "campusId" : "e4cb3320-adba-4412-98fe-1f8576ec50db"
}' \
$protocol://$host/location-units/libraries
...
-d '{
 ...
 "name" : "Temple - Special Collections Research Center",
 "code" : "SCRC",
 "campusId" : "e4cb3320-adba-4412-98fe-1f8576ec50db"
}' \
$protocol://$host/location-units/libraries
