  ...
  <xsl:template match="//marc:record">
    ...
    <holdingsRecords>
      ...
      <xsl:if test="marc:datafield[@tag='852']">
        <xsl:for-each select="marc:datafield[@tag='852'][not(starts-with(./marc:subfield[@code='b'], 'WITHDREW'))]">
          ...
          <xsl:if test="not($loc=$preloc)">
            <i>
              ...
              <illPolicyId>
                <xsl:choose>
                  <xsl:when test="$loc='BOOK'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when> <!-- Will lend -->
                  <xsl:when test="$loc='STORAGE'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when> <!-- Will lend -->
                  <xsl:when test="$loc='GA-BOOK'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when> <!-- Will lend -->
              ...
              <callNumberTypeId>
                ...
                <xsl:choose>
                  ...
                  <xsl:when test="$ctype='2'">054d460d-d6b9-4469-9e37-7a78a2266655</xsl:when> <!-- NLM -->
                  <xsl:when test="$ctype='4'">fc388041-6cd0-4806-8a74-ebe3b9ab4c6e</xsl:when> <!-- Sudoc -->
              ...
              <items>
                <arr>
                <xsl:for-each select="../marc:datafield[@tag='852']/marc:subfield[@code='b'][.=$loc]/..">
                  <i>
