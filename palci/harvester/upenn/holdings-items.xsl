          ...
          <arr>
            <xsl:for-each select="marc:datafield[@tag='900' and @ind1!='4' and @ind1!=' ']">
              ...
              <i>
                ...
                <illPolicyId>
                  <xsl:choose>
                    <xsl:when test="$LOC='LippLib lipp'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='VanPeltLib easiaover'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='VanPeltLib eastasia'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='VanPeltLib vanp'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='VanPeltLib vpnewbook'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='VanPeltLib yarn'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
