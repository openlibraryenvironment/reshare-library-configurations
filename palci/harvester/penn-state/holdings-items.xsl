        ...
        <xsl:for-each select="marc:datafield[@tag='949']">
          ...
          <xsl:if test="not($curkey=$prekey)">
            <i>
              ...
              <illPolicyId>
                <xsl:choose>
                  <xsl:when test="$loc='JUV'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc='OVERSIZE'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc='SHELVES'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc='YCP_AUTH'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc='MFILM'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc='MFICHE'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
              ...
              <items>
                <arr>
                <xsl:for-each select="../marc:datafield[@tag='999' and ./marc:subfield[@code='l']=$loc and ./marc:subfield[@code='a']=$callno]">
                  <i>
