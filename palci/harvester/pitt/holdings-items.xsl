          ...
          <arr>
            <xsl:for-each select="marc:datafield[@tag='900' and @ind1!='4' and @ind1!=' ']">
              ...
              <i>
                ...
                <illPolicyId>
                    <xsl:choose>
                    <xsl:when test="$LOC='ENGR stks'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='UPB stks'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='UPB over'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='CHEM stks'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='MUS stks'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='MUS over'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='ART stksfac'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='ART stks'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='UPG stks'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='UPG graph'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='UPG young'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='HILL stksafro'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='HILL stksalld'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='HILL dis'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='HILL stkseac'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='HILL stkseaj'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='HILL stkseak'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='HILL stks'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='UPJ stks'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='UPJ graph'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='LANG stks'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='LANG over'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='UPT stks'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='THOM stor'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                ...
                <xsl:for-each select="../marc:datafield[@tag='900' and @ind1='4' and ./marc:subfield[@code='8']=$holdingsId]">
                    ...
                    <xsl:for-each select="../marc:datafield[@tag='995']">
                      <xsl:if test="marc:subfield[@code='ff']=$holdingsId">
                        <i>
                          ...
                          <permanentLocationIdHere><xsl:value-of select="concat(./marc:subfield[@code='h'], ' ', marc:subfield[@code='aa'])"/></permanentLocationIdHere>
                        </i>
                      </xsl:if>
                    </xsl:for-each>
                  </arr>
