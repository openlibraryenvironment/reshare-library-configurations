          ...
          <arr>
            <xsl:for-each select="marc:datafield[@tag='900' and @ind1!='4' and @ind1!=' ']">
              ...
              <i>
                ...
                <xsl:variable name="LOC" select="concat(marc:subfield[@code='b'], ' ', marc:subfield[@code='d'])" />
                <illPolicyId>
                    <xsl:choose>
                      <xsl:when test="$LOC='MAN 1FN'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='MAN 1FS'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='MAN CSTK'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='MAN 4FN'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='MAN 4FS'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='MAN 3FN'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='MAN 3FS'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='MAN 2FN'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='MAN ATR3'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='MAN ATR2'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='MAN ATR1'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='bloom GENCOLL'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='bloom GENCOLLOV'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='bloom JUVENILE'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='bloom JUVENILEOV'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='bloom JUVFIC'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='bloom JUVFICOV'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='bloom JUVNONFIC'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='bloom JUVNONFOV'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='bloom NewBooks'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Stevenson CALD'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Stevenson CDMUS'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Stevenson CHIL'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Clearfield CLEAR'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Clearfield CLEARADBK'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Clearfield CLEARCAR'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Clearfield CLEARCHIL'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Clearfield CLEARFOL'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Clearfield CLEARLREAD'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Stevenson CUR'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Stevenson E-CHIL'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Stevenson FOL'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Stevenson LREAD'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Stevenson MAIN'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Stevenson NBC'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Stevenson NBS'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Stevenson NEWBERY'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Stevenson PER'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Stevenson PICBOO'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$LOC='Stevenson TFOL'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                ...
                <callNumberTypeId>
                  <xsl:variable name="CNTYPE" select="../marc:datafield[@tag='995' and ./marc:subfield[@code='ff']=$holdingsId][1]/marc:subfield[@code='j']" />
                  <xsl:choose>
