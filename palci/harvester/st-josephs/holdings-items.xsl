          ...
          <arr>
            <xsl:for-each select="marc:datafield[@tag='900' and @ind1!='4' and @ind1!=' ']">
              ...
              <i>
                ...
                <illPolicyId>
                    <xsl:choose>
                    <xsl:when test="$LOC='JWEL Main'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='JWEL Leisure'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='SD bks1'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='SD bks2'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='SD bks3'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='SD campbk'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='SD cmclit'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
