            ...
            <xsl:for-each select="marc:datafield[@tag='952']">
              ...
              <xsl:if test="not($loc=$preloc)">
                <i>
                  ...
                  <illPolicyId>
                    <xsl:choose>
                      <xsl:when test="$loc='CIRC2'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$loc='CIRC3'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$loc='CC'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$loc='FEATURE'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$loc='FOLIO'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$loc='OLKES'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                      <xsl:when test="$loc='POPULAR'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  ...
                  <items>
                    ...
                    <xsl:for-each select="../marc:datafield[@tag='952']/marc:subfield[@code='c'][.=$loc]/..">
                      <i>
                        ...
                        <volume><xsl:value-of select="./marc:subfield[@code='h']"/></volume>
                      </i>
                    </xsl:for-each>
                    </arr>
                  </items>
