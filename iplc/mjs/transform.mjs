...
const localFields = {
  ...
  'US-NNC': {
    ...
    lendLocs: [ 'avelc', 'bar', 'bar,four', 'bar,medi', 'bar,new', 'bar,over', 'bar,three', 'bar,two', 'bar,znz', 'bmc', 'bus', 'docs', 'faxlc', 'glg', 'glx', 'glx,fol', 'glx,pre', 'gnc', 'hsl', 'jou', 'lawgn2', 'lawgn2e', 'lawgn2w', 'lawgn3', 'lawgn4', 'leh', 'mat', 'mat,over', 'mil', 'mil,over', 'mrr', 'msc', 'msr', 'mus', 'mvr', 'off,bio', 'off,bus', 'off,che', 'off,docs', 'off,eal', 'off,eax', 'off,eng', 'off,glg', 'off,glx', 'off,gnc', 'off,gsc', 'off,hsl', 'off,jou', 'off,leh', 'off,mat', 'off,mrr', 'off,msr', 'off,mus', 'off,mvr', 'off,phy', 'off,psy', 'off,sci', 'off,swx', 'off,uts', 'off,war', 'pat', 'sci', 'swx', 'uts', 'uts,unn', 'war' ]
    // lendLocs: ["bar","bar,four","bar,medi","bar,new","bar,over","bar,three","bar,two","bar,znz","bmc","bus","docs","eal","eax","glg","glx","glx,pre","gnc","hsl","jou","lawgnb3","lawgnb8","lawgnb8f","lawgnc","lawgns1","lawgns2","lawrsear","leh","mil","msc","msr","mus","mvr","off,bio","off,bus","off,docs","off,eal","off,eax","off,eng","off,glg","off,glx","off,gnc","off,gsc","off,hsl","off,jou","off,leh","off,mat","off,msr","off,mus","off,mvr","off,phy","off,psy","off,sci","off,swx","off,uts","off,war","pat","sci","swx","uts","uts,unn"]
  },
  'US-PU': {
    name: 'Penn',
    tag: '995',
