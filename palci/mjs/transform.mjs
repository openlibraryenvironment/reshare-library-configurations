...
const localFields = {
  ...
  'US-PRALV': {
    ...
    lendLocs: [ 'DVDs – Wellness Zone, 1st Floor', 'Easy Reading Collection - 1st Floor', 'General Collection - 1st Floor', 'General Collection - 2nd Floor', 'Leisure Reading', 'Young Adult Fiction - 1st Floor', 'Young Adult Nonfiction - 1st Floor' ]
  },
  'US-PSHS': {
