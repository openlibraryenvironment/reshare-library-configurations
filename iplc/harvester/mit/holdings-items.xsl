      ...
      <xsl:if test="marc:datafield[@tag='949']">
        <xsl:for-each select="marc:datafield[@tag='949']">
          ...
          <xsl:variable name="preloc">
            <xsl:value-of select="./preceding-sibling::marc:datafield[@tag='949'][1]/marc:subfield[@code='c']"/>
          </xsl:variable>
          ...
          <xsl:if test="not($loc=$preloc)">
            <i>
              ...
              <callNumber><xsl:value-of select="./marc:subfield[@code='h']"/></callNumber>
              ...
              <items>
                <arr>
                <xsl:for-each select="../marc:datafield[@tag='949']/marc:subfield[@code='c'][.=$loc]/..">
                  <i>
                    ...
                    <copyNumber><xsl:value-of select="./marc:subfield[@code='xxx']"/></copyNumber>
