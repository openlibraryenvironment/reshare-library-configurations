    ...
    <xsl:template match="//marc:record">
        ...
        <instance>
            ...
            <instanceTypeId>
                ...
                <xsl:choose>
                <xsl:when test="substring(marc:leader,1,1)='a'">6312d172-f0cf-40f6-b27d-9fa8feaf332f</xsl:when> <!-- language material : text -->
                <xsl:when test="substring(marc:leader,1,1)='c'">497b5090-3da2-486c-b57f-de5bb3c2e26d</xsl:when> <!-- notated music : notated music -->
                <xsl:when test="substring(marc:leader,1,1)='d'">497b5090-3da2-486c-b57f-de5bb3c2e26d</xsl:when> <!-- manuscript notated music : notated music -> notated music -->
                <xsl:when test="substring(marc:leader,1,1)='e'">526aa04d-9289-4511-8866-349299592c18</xsl:when> <!-- cartographic material : cartographic image -->
                <xsl:when test="substring(marc:leader,1,1)='f'">a2c91e87-6bab-44d6-8adb-1fd02481fc4f</xsl:when> <!-- other --> <!-- manuscript cartographic material : ? -->
                <xsl:when test="substring(marc:leader,1,1)='g'">535e3160-763a-42f9-b0c0-d8ed7df6e2a2</xsl:when> <!-- projected image : still image -->
                <xsl:when test="substring(marc:leader,1,1)='i'">9bce18bd-45bf-4949-8fa8-63163e4b7d7f</xsl:when> <!-- nonmusical sound recording : sounds -->
                <xsl:when test="substring(marc:leader,1,1)='j'">3be24c14-3551-4180-9292-26a786649c8b</xsl:when> <!-- musical sound recording : performed music -->
                <xsl:when test="substring(marc:leader,1,1)='k'">a2c91e87-6bab-44d6-8adb-1fd02481fc4f</xsl:when> <!-- other --> <!-- two-dimensional nonprojectable graphic : ?-->
                <xsl:when test="substring(marc:leader,1,1)='m'">df5dddff-9c30-4507-8b82-119ff972d4d7</xsl:when> <!-- computer file : computer dataset -->
                <xsl:when test="substring(marc:leader,1,1)='o'">a2c91e87-6bab-44d6-8adb-1fd02481fc4f</xsl:when> <!-- kit : other -->
                <xsl:when test="substring(marc:leader,1,1)='p'">a2c91e87-6bab-44d6-8adb-1fd02481fc4f</xsl:when> <!-- mixed material : other -->
                <xsl:when test="substring(marc:leader,1,1)='r'">c1e95c2b-4efc-48cf-9e71-edb622cf0c22</xsl:when> <!-- three-dimensional artifact or naturally occurring object : three-dimensional form -->
                <xsl:when test="substring(marc:leader,1,1)='t'">6312d172-f0cf-40f6-b27d-9fa8feaf332f</xsl:when> <!-- manuscript language material : text -->
