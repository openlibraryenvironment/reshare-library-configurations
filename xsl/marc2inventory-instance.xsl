    ...
    <record>
      <xsl:choose>
        <xsl:when test="substring(marc:leader, 6, 1)='d'">
            <delete>
                <oaiIdentifier><xsl:value-of select="marc:controlfield[@tag='001']"/></oaiIdentifier>
        ...
        <xsl:otherwise>
          ...
          <instance>
            ...
            <!-- Identifiers -->
            <xsl:if test="marc:datafield[@tag='010' or @tag='020' or @tag='022' or @tag='024' or @tag='028' or @tag='035' or @tag='074']                         or marc:controlfield[@tag='001']">
              <identifiers>
                <arr>
