...
def main(argv):
    ...
    """
    filename = 'HARVESTABLE-to-cny-remote{}501.xml'.format(baseid)
    f = open(filename,"w")
    f.write('<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\n')
    f.write('<harvestable>\n')
    f.write('  <{}>\n'.format(jobtype))
    f.write('    <id>{}501</id>\n'.format(baseid))
    f.write('    <name>CNY: {} to CNY SI Remote</name>\n'.format(library))
    f.write('    <url>{}</url>\n'.format(url))
    if jobtype == 'oaiPmh':
    ...
    f.write('  <{}>\n'.format(jobtype))
    f.write('    <id>{}502</id>\n'.format(baseid))
    f.write('    <name>CNY: {} to localhost</name>\n'.format(library))
    f.write('    <url>{}</url>\n'.format(url))
    if jobtype == 'oaiPmh':
        f.write('    <oaiSetName>{}</oaiSetName>\n'.format(oaisetname))
        f.write('    <metadataPrefix>marc21</metadataPrefix>\n')
    ...
    f.write('  <{}>\n'.format(jobtype))
    f.write('    <id>{}503</id>\n'.format(baseid))
    f.write('    <name>CNY: {} to SI dev</name>\n'.format(library))
    f.write('    <url>{}</url>\n'.format(url))
    if jobtype == 'oaiPmh':
        f.write('    <oaiSetName>{}</oaiSetName>\n'.format(oaisetname))
        f.write('    <metadataPrefix>marc21</metadataPrefix>\n')
