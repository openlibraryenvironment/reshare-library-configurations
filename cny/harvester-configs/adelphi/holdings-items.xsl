          ...
          <arr>
            <xsl:for-each select="marc:datafield[@tag='900' and @ind1!='4' and @ind1!=' ']">
              ...
              <i>
                ...
                <illPolicyId>
                  <xsl:choose>
                    <xsl:when test="$LOC='MAIN main'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='MAIN clevel'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='MAIN microforms'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='MAIN dvd'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='HAUP dvd'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='HAUP main'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='MH dvd'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='MH main'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:when test="$LOC='MH vhs'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                    <xsl:otherwise>b0f97013-87f5-4bab-87f2-ac4a5191b489</xsl:otherwise>
                  </xsl:choose>
                </illPolicyId>
