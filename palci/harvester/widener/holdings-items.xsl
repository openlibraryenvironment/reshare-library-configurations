        ...
        <xsl:for-each select="marc:datafield[@tag='945']">
          ...
          <xsl:if test="not($loc=$preloc)">
            <i>
              ...
              <illPolicyId>
                <xsl:choose>
                  <xsl:when test="$loc-clean='mcir'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc-clean='mcurc'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc-clean='mcum'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
                  <xsl:when test="$loc-clean='mtxc'">46970b40-918e-47a4-a45d-b1677a2d3d46</xsl:when>
              ...
              <xsl:variable name='OTHER' select="../marc:datafield[@tag='090' or @tag='099']"/>
              <xsl:choose>
                ...
                <xsl:when test="$OTHER">
                  <callNumber><xsl:value-of select="normalize-space(concat($OTHER/marc:subfield[@code='a'], ' ', $OTHER/marc:subfield[@code='b']))"/></callNumber>
                  <callNumberTypeId>6caca63e-5651-4db6-9247-3205156e9699</callNumberTypeId> <!-- OTHER -->
                </xsl:when>
              </xsl:choose>
              <notes>
                <arr>
