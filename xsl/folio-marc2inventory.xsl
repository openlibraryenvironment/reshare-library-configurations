...
<xsl:stylesheet
    ...
    <record>
        ...
        <xsl:variable name="localId" select="marc:datafield[@tag='999' and @ind1='f' and @ind2='f']/marc:subfield[@code='i']"/>
        <institutionIdHere/>
        <localIdentifier><xsl:value-of select="$localId" /></localIdentifier>
        ...
        <instance>
            ...
            <xsl:if test="marc:datafield[@tag='010' or @tag='020' or @tag='022' or @tag='024' or @tag='028' or @tag='035' or @tag='074']
                ...
                <arr>
                  <i>
                    <value><xsl:value-of select="$localId"/></value>
