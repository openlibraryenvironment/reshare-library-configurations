...
const localFields = {
  ...
  'US-CTY': {
    ...
    lendLocs: [ 'adswkrm', 'artdesk', 'artdisplay', 'artmain', 'artnew', 'artpopup', 'arttransfe', 'bassdis', 'bassgraph', 'bassmain', 'divcd', 'divdisp', 'divdmr', 'divjuv', 'divnb', 'divmain', 'graphicmed', 'lawbl', 'lsfart', 'lsfdiv', 'lsfgdc', 'lsfi', 'lsfmain', 'lsfmarx', 'lsfmarxmap', 'lsfmtn', 'lsfmus', 'marxdisp', 'marxdisp2', 'marxmain', 'marxnew', 'marxstaff', 'medbiog', 'medhs', 'medhum', 'medmain', 'mednew', 'medrefeol', 'monthlydis', 'musmain', 'musmic', 'musnb', 'musrec', 'new', 'rr', 'smlfolio', 'smllnb', 'smllnbm', 'smllts', 'smlmic', 'smlmicr', 'smlstacks', 'smltadoku' ]
  },
  'US-ICU': {
  ...
  'US-NNC': {
    ...
    lendLocs: [ 'avelc', 'bar', 'bar,four', 'bar,medi', 'bar,new', 'bar,over', 'bar,three', 'bar,two', 'bar,znz', 'bmc', 'bus', 'docs', 'faxlc', 'glg', 'glx', 'glx,fol', 'glx,pre', 'gnc', 'hsl', 'jou', 'lawgn2', 'lawgn2e', 'lawgn2w', 'lawgn3', 'lawgn4', 'leh', 'mat', 'mat,over', 'mil', 'mil,over', 'mrr', 'msc', 'msr', 'mus', 'mvr', 'off,bio', 'off,bus', 'off,che', 'off,docs', 'off,eal', 'off,eax', 'off,eng', 'off,glg', 'off,glx', 'off,gnc', 'off,gsc', 'off,hsl', 'off,jou', 'off,leh', 'off,mat', 'off,mrr', 'off,msc', 'off,msr', 'off,mus', 'off,mvr', 'off,phy', 'off,psy', 'off,sci', 'off,swx', 'off,uts', 'off,war', 'pat', 'sci', 'swx', 'uts', 'uts,unn', 'war' ]
  },
  'US-PU': {
    name: 'Penn',
    tag: '995',
